...
export const FlowSection = ({
  ...
  >
    <div
      data-flow-inner
      className={cx(
        'flow-art-container relative flex min-h-screen w-full flex-col justify-between gap-6 px-[4vw] pt-[clamp(6rem,10vw,7rem)] pb-[4vw]',
        'will-change-transform shadow-[0_-20px_50px_rgba(0,0,0,0.3)]',
      )}
